...
if __name__ == '__main__':
    ...
    datasets = []
    # dataset1_details = {
    #         'data': loader.BreastCancerWiscData(verbose=verbose, seed=seed),
    #         'name': 'breast_cancer_w',
    #         'readable_name': 'Breast Cancer Wisc',
    #         'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [1.0],
    #                            'NN__hidden_layer_sizes': [(3, 3, 3)], 'NN__learning_rate_init': [0.3]}
    #     }
    # dataset2_details = {
    ...
    # }
    dataset1_details = {
            'data': loader.BloodTransData(verbose=verbose, seed=seed),
            'name': 'blood trans',
            'readable_name': 'Blood Transfusion',
            'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [1.0],
                               'NN__hidden_layer_sizes': [(6, 6, 6)], 'NN__learning_rate_init': [0.15]}
    }
    dataset2_details = {
            'data': loader.MonksData(verbose=verbose, seed=seed),
            'name': 'monks',
            'readable_name': 'Monks Problem',
            'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [1.0],
                               'NN__hidden_layer_sizes': [(3)], 'NN__learning_rate_init': [0.3]}
    }
    if args.dataset1:
