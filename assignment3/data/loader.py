...
class DataLoader(ABC):
    ...
    def load_and_process(self, data=None, preprocess=True):
        ...
        self.classes = self.classes.astype(np.float)
    ...
    def scale_standard(self):
        # self.features = self.features.astype(np.float)
        print("****")
        index = 0
...
class BloodTransData(DataLoader):
    def __init__(self, path='data/blood-transfusion-service.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def data_name(self):
        return 'Blood Transfusion Service'
...
class MonksData(DataLoader):
    def __init__(self, path='data/monks-problem.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
# class BreastCancerWiscData(DataLoader):
#     def __init__(self, path='data/breast-w-norm.csv', verbose=False, seed=1):
#         super().__init__(path, verbose, seed)
...
#     def __init__(self, path='data/wine-norm.csv', verbose=False, seed=1):
#         super().__init__(path, verbose, seed)
